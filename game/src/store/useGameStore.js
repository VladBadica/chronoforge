...
export const useGameStore = create((set) => {
  ...
  gameEngine.setTickCallback((snapshot) => {
    set({
      ...
      maxSpeedReached: snapshot.maxSpeedReached,
      timesAscended: snapshot.timesAscended,
      ...
      prestigeClockRefund:  snapshot.prestigeClockRefund,
      prestigeAnchorRefund: snapshot.prestigeAnchorRefund,
  ...
  return {
    ...
    prestigeClockRefund:  0,
    prestigeAnchorRefund: 0,
    ...
    refundPrestigeClock:  () => { gameEngine.refundPrestigeClock(); },
    refundPrestigeAnchor: () => { gameEngine.refundPrestigeAnchor(); },
